...
export default function Container(props: ContainerProps) {
  ...
  const meta = {
    ...
    description: `${personalInfo.title} | ${personalInfo.subtitle}`,
  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://github.com/m21102001${router.asPath}`}
        />
        <link
          rel="canonical"
          href={`https://github.com/m21102001${router.asPath}`}
        />
        ...
        <meta name="twitter:site" content="@m21102001" />
      ...
      >
        ...
        <Link href="/">
          <span className="text-lg font-semibold lowercase">m.elfayoumy</span>
        </Link>
